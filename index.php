<!-- CODE BY ASHIKUL ISLAM AKASH @iamashikkulakash -->
<?php
    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: AIA Fashion.<br>
            180-182 RN ROAD, JESSORE-7400.
          </address>
            <div class="phone">
              Telephone:
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> AIA Fashion&trade;
          </div>

          <div class="developer">
          Design & Developed by ASHIKUL AKASH
          </div>
